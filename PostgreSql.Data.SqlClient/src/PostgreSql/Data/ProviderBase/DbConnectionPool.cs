...
namespace System.Data.ProviderBase
{
    internal sealed class DbConnectionPool
    {
        ...
        internal DbConnectionPool(DbConnectionFactory          connectionFactory
...
#warning TODO: Should the obj.Dispose call be inside the if block ??
        ...
        // This functions clones PgException. 
        private Exception TryCloneCachedException()
        {
            ...
            var error = _resError as PostgreSql.Data.SqlClient.PgException;
            if (error != null)
            {
                return error.InternalClone();
            }
            return _resError;
        }
...
#warning Empty try
        ...
        private bool ReclaimEmancipatedObjects()
        {
            ...
            var reclaimedObjects = new List<DbConnectionInternal>();
            int count;
