...
namespace PostgreSql.Data.SqlClient.Tests
{
    public static class DateTimeTest
    {
        ...
        //     string prepTable1 = "CREATE TABLE " + tempTable + " (ci int, c0 timestamp, c1 date, c2 time, c3 timestamp, c4 timestamp with timezone)";
        ...
        //             PgParameter pi = cmd2.Parameters.Add("@pi", PgDbType.Integer);
        //             PgParameter p0 = cmd2.Parameters.Add("@p0", PgDbType.Timestamp);
        //             PgParameter p1 = cmd2.Parameters.Add("@p1", PgDbType.Date);
        //             PgParameter p2 = cmd2.Parameters.Add("@p2", PgDbType.Time);
        //             PgParameter p3 = cmd2.Parameters.Add("@p3", PgDbType.Timestamp);
        //             PgParameter p4 = cmd2.Parameters.Add("@p4", PgDbType.TimestampTZ);
        ...
        //             pi = cmd2.Parameters.Add("@pi", PgDbType.Integer);
        //             p0 = cmd2.Parameters.Add("@p0", PgDbType.Timestamp);
        //             p1 = cmd2.Parameters.Add("@p1", PgDbType.Date);
        //             p2 = cmd2.Parameters.Add("@p2", PgDbType.Time);
        //             p3 = cmd2.Parameters.Add("@p3", PgDbType.Timestamp);
        //             p4 = cmd2.Parameters.Add("@p4", PgDbType.TimestampTZ);
        //             pi.PgValue = new PgInt32(0);
        //             p0.PgValue = new PgTimestamp(1753, 1, 1, 0, 0, 0);
        //             p1.PgValue = new DateTime(1753, 1, 1, 0, 0, 0);
        //             p2.PgValue = new TimeSpan(0, 20, 12, 13, 360);
        //             p3.PgValue = new DateTime(2000, 12, 31, 23, 59, 59, 997);
        //             p4.PgValue = new DateTimeOffset(9999, 12, 31, 23, 59, 59, 997, TimeSpan.Zero);
        //             p2.Scale = 3;
        //             p3.Scale = 3;
        //             p4.Scale = 3;
        ...
        //             p0 = cmd3.Parameters.Add("@p0", PgDbType.Timestamp);
        //             p1 = cmd3.Parameters.Add("@p1", PgDbType.Date);
        //             p2 = cmd3.Parameters.Add("@p2", PgDbType.Time);
        //             p3 = cmd3.Parameters.Add("@p3", PgDbType.Timestamp);
        //             p4 = cmd3.Parameters.Add("@p4", PgDbType.TimestampTZ);
        ...
        //             Assert.True(p0.Value.Equals((new PgTimestamp(1753, 1, 1, 0, 0, 0)).Value), "FAILED: PgParameter p0 contained incorrect value");
        ...
        //             Assert.False(IsValidParam(PgDbType.Date, "c1", new PgTimestamp(1753, 1, 1, 0, 0, 0), conn, tempTable), "FAILED: Invalid param for Date PgDbType");
        ...
        //             Assert.False(IsValidParam(PgDbType.Time, "c2", new PgTimestamp(1753, 1, 1, 0, 0, 0), conn, tempTable), "FAILED: Invalid param for Time PgDbType");
        ...
        //             Assert.False(IsValidParam(PgDbType.DateTime2, "c3", new PgTimestamp(2000, 12, 31, 23, 59, 59, 997), conn, tempTable), "FAILED: Invalid param for DateTime2 PgDbType");
        ...
        //             Assert.False(IsValidParam(PgDbType.DateTimeOffset, "c4", new PgTimestamp(1753, 1, 1, 0, 0, 0), conn, tempTable), "FAILED: Invalid param for DateTimeOffset PgDbType");
        ...
        //                                 parsingSucceeded = false;
        //                             }
        //                             Assert.True(parsingSucceeded, "FAILED: PgDataReader parsing failed for column: " + i);
        ...
        //                             string[] valueStrList =
        //                             {
        //                                 sqlValues[i].ToString(), rdr.GetPgValue(i).ToString(), psValues[i].ToString(),
        //                                 rdr.GetProviderSpecificValue(i).ToString(), values[i].ToString(), rdr.GetValue(i).ToString()
        //                             };
        //                             string[] valueNameList = { "sqlValues[]", "GetPgValue", "psValues[]", "GetProviderSpecificValue", "values[]", "GetValue" };
        ...
        //             using (var cmd = conn.CreateCommand())
        //             {
        //                 cmd.CommandText = $"DROP FUNCTION {tempProc}";
        //                 cmd.ExecuteNonQuery();
        //             }
        //             using (var cmd = conn.CreateCommand())
        //             {
        //                 cmd.CommandText = $"DROP FUNCTION {tempProcN}";
        //                 cmd.ExecuteNonQuery();
        //             }
        //         }                
        //     }
        ...
        // private static bool IsString(PgDataReader rdr, int column)
        // {
        ...
        // private static bool IsNotString(PgDataReader rdr, int column)
        // {
        //     if (!rdr.IsDBNull(column))
        //     {
        //         try
        ...
        // private static void ValidateReader(PgDataReader rdr, int column)
        // {
        ...
        //     // in PgDataReader, which requires different server versions to handle NULLs differently.
        //     // Empty string is expected for DBNull SqlValue (as per API), but SqlServer 2005 returns "Null" for it.
        //     // See GetSqlValue code path in PgDataReader for more details
        //     if (!validateSucceeded && rdr.IsDBNull(column) && rdr.GetValue(column).ToString().Equals(""))
        //     {
        //         validateSucceeded = true;
        //     }

        //     Assert.True(validateSucceeded, string.Format("FAILED: PgDataReader failed reader validation for column: {0}. Column literal value: {1}", column, rdr.GetSqlValue(column)));
        // }
    }
}
