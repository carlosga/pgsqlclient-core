...
namespace PostgreSql.Data.SqlClient.UnitTests
{
        ...
        : PgBaseTest
    {
        ...
        public void PointTest()
        {
            ...
            {
                command.Parameters.Add("@pk", PgDbType.Integer).Value = 50;
        ...
        public void BoxTest()
        {
            ...
            {
                command.Parameters.Add("@pk", PgDbType.Integer).Value = 70;
        ...
        public void CircleTest()
        {
            ...
            {
                command.Parameters.Add("@pk", PgDbType.Integer).Value = 30;
        ...
        public void LineSegmentTest()
        {
            ...
            {
                command.Parameters.Add("@pk", PgDbType.Integer).Value = 20;
        ...
        public void PathTest()
        {
            ...
            {
                command.Parameters.Add("@pk", PgDbType.Integer).Value = 10;
