...
namespace PostgreSql.Data.PostgreSqlClient
{
        ...
        : DbParameterCollection
    {
        ...
        {
            _parameters.CopyTo((PgParameter[])array, index);
        }
        ...
        {
            return Add(new PgParameter(parameterName, value));
        }

        public PgParameter Add(string parameterName, PgDbType providerType)
        {
            return Add(new PgParameter(parameterName, providerType));
        }

        public PgParameter Add(string parameterName, PgDbType providerType, int size)
        {
            return Add(new PgParameter(parameterName, providerType, size));
        }
