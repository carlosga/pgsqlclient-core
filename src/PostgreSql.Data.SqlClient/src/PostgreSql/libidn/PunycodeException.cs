...
namespace Gnu.Inet.Encoding
{
    ...
    public sealed class PunycodeException : Exception
    {
        internal static string OVERFLOW   = "Overflow.";
        internal static string BAD_INPUT  = "Bad input.";
        ...
        /// </summary>
        /// <param name="message">message</param>
        public PunycodeException(string message, Exception innerException) : base(message, innerException)
        {
        }
    }
}
