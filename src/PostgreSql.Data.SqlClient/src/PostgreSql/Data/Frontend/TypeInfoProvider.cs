...
namespace PostgreSql.Data.Frontend
{
    internal sealed class TypeInfoProvider
    {
        ...
        static TypeInfoProvider()
        {
            ...
            types[18] = new TypeInfo(18, "byte", "char", PgDbType.Byte, typeof(byte), typeof(PgByte), sizeof(byte));

            //
            // BINARY DATA TYPES
            //

            types[17  ] = new TypeInfo(  17, "bytea"  , "bytea" , PgDbType.Bytea, typeof(byte[]), typeof(PgBinary));
            ...
            types[1560] = new TypeInfo(1560, "bit"   , "bit"   , PgDbType.Byte, typeof(byte), typeof(PgBit), sizeof(byte));
            ...
            types[  16] = new TypeInfo(  16, "bool"  , "bool" , PgDbType.Boolean, typeof(bool), typeof(PgBoolean), sizeof(bool));
            ...
            types[1043] = new TypeInfo(1043, "varchar"  , "varchar" , PgDbType.VarChar, typeof(string), typeof(string));
            ...
            types[  25] = new TypeInfo(  25, "text"  , "text" , PgDbType.Text , typeof(string), typeof(string));
            ...
            types[1114] = new TypeInfo(1114, "timestamp"  , "timestamp" , PgDbType.Timestamp, typeof(DateTime), typeof(PgTimestamp), 8);
            ...
            types[1184] = new TypeInfo(1184, "timestamptz"  , "timestamptz" , PgDbType.TimestampTZ, typeof(DateTimeOffset), typeof(PgTimestamp), 8);
            ...
            types[1082] = new TypeInfo(1082, "date"  , "date" , PgDbType.Date , typeof(PgDate), typeof(PgDate), 4);
            types[1182] = new TypeInfo(1182, "date[]", "_date", PgDbType.Array, types[1082], typeof(PgDate[]), typeof(PgDate[]));

            // time [ (p) ] [ without time zone ] | 8 bytes | time of day (no date) | 00:00:00 | 24:00:00 | 1 microsecond / 14 digits

            types[1083] = new TypeInfo(1083, "time"  , "time" , PgDbType.Time , typeof(TimeSpan), typeof(PgTime), 8);
            types[1183] = new TypeInfo(1183, "time[]", "_time", PgDbType.Array, types[1083], typeof(TimeSpan[]), typeof(PgTime[]));
            
            // time [ (p) ] with time zone | 12 bytes | times of day only, with time zone | 00:00:00+1459 | 24:00:00-1459 | 1 microsecond / 14 digits

            types[1266] = new TypeInfo(1266, "timetz"  , "timetz" , PgDbType.TimeTZ, typeof(DateTimeOffset), typeof(PgTime), 12);
            ...
            types[1186] = new TypeInfo(1186, "interval"  , "interval" , PgDbType.Interval, typeof(TimeSpan), typeof(PgInterval), 16);
            ...
            types[  21] = new TypeInfo(  21, "smallint"  , "int2"      , PgDbType.SmallInt, typeof(short), typeof(PgInt16), sizeof(short));
            ...
            types[  23] = new TypeInfo(  23, "integer"  , "int4" , PgDbType.Integer, typeof(int), typeof(PgInt32), sizeof(int));
            types[1007] = new TypeInfo(1007, "integer[]", "_int4", PgDbType.Array  , types[23], typeof(int[]), typeof(PgInt32[]));

            // bigint | 8 bytes | large-range integer | -9223372036854775808 to +9223372036854775807

            types[  20] = new TypeInfo(  20, "bigint"  , "int8" , PgDbType.BigInt, typeof(long), typeof(PgInt64), sizeof(long));
            ...
            types[1700] = new TypeInfo(1700, "numeric"  ,  "numeric", PgDbType.Numeric, typeof(decimal), typeof(PgDecimal));
            types[1231] = new TypeInfo(1231, "numeric[]", "_numeric", PgDbType.Array  , types[1700], typeof(decimal[]), typeof(PgDecimal[]));

            // real | 4 bytes | variable-precision, inexact	6 decimal digits precision

            types[ 700] = new TypeInfo( 700, "real"  , "float4" , PgDbType.Real , typeof(float), typeof(PgReal), sizeof(float));
            types[1021] = new TypeInfo(1021, "real[]", "_float4", PgDbType.Array, types[700], typeof(float[]), typeof(PgReal));

            // double precision | 8 bytes | variable-precision, inexact	15 decimal digits precision

            types[ 701] = new TypeInfo( 701, "double"  , "float8" , PgDbType.Double, typeof(double), typeof(PgDouble), sizeof(double));
            ...
            types[790] = new TypeInfo(790, "money"  , "money" , PgDbType.Money, typeof(decimal), typeof(PgMoney), 8);
            ...
            types[  19] = new TypeInfo(  19, "name"    , "name"   , PgDbType.VarChar, typeof(string), typeof(string));
            ...
            types[ 600] = new TypeInfo( 600, "point"  , "point" , PgDbType.Point, types[701], typeof(PgPoint), typeof(PgPoint), 16);
            types[1017] = new TypeInfo(1017, "point[]", "_point", PgDbType.Array, types[600], typeof(PgPoint[]), typeof(PgPoint[]));

            // line	| 32 bytes | Infinite line {A,B,C}

            types[628] = new TypeInfo(628, "line"  , "line" , PgDbType.Line , types[701], typeof(PgLine), typeof(PgLine), 32);
            types[629] = new TypeInfo(629, "line[]", "_line", PgDbType.Array, types[628], typeof(PgLine[]), typeof(PgLine[]));

            // lseg	| 32 bytes | Finite line segment | ((x1,y1),(x2,y2))

            types[ 601] = new TypeInfo( 601, "lseg"  , "lseg" , PgDbType.LSeg , types[600], typeof(PgLSeg), typeof(PgLSeg), 32);
            types[1018] = new TypeInfo(1018, "lseg[]", "_lseg", PgDbType.Array, types[601], typeof(PgLSeg[]), typeof(PgLSeg[]));

            // box | 32 bytes | Rectangular box | ((x1,y1),(x2,y2))

            types[ 603] = new TypeInfo( 603, "box"  , "box" , PgDbType.Box  , types[600], typeof(PgBox), typeof(PgBox), 32);
            types[1020] = new TypeInfo(1020, "box[]", "_box", PgDbType.Array, types[603], typeof(PgBox[]), typeof(PgBox[]));

            // path | 16+16n bytes | Closed path (similar to polygon) |	((x1,y1),...)
            // path | 16+16n bytes | Open path                        | [(x1,y1),...]

            types[ 602] = new TypeInfo( 602, "path"  , "path" , PgDbType.Path , typeof(PgPath), typeof(PgPath), 16);
            types[1019] = new TypeInfo(1019, "path[]", "_path", PgDbType.Array, types[602], typeof(PgPath[]), typeof(PgPath[]));

            // polygon | 40+16n bytes | Polygon (similar to closed path) | ((x1,y1),...)

            types[ 604] = new TypeInfo( 604, "polygon"  , "polygon" , PgDbType.Polygon, typeof(PgPolygon), typeof(PgPolygon), 40);
            types[1027] = new TypeInfo(1027, "polygon[]", "_polygon", PgDbType.Array  , types[604], typeof(PgPolygon[]), typeof(PgPolygon[]));

            // circle | 24 bytes | Circle | <(x,y),r> (center point and radius)

            types[718] = new TypeInfo(718, "circle"  , "circle" , PgDbType.Circle, typeof(PgCircle), typeof(PgCircle), 24);
            ...
            types[17321] = new TypeInfo(17321, "box3d", "box3d", PgDbType.Box3D, typeof(PgBox3D), typeof(PgBox3D), 48);
            types[17335] = new TypeInfo(17335, "box2d", "box2d", PgDbType.Box2D, typeof(PgBox2D), typeof(PgBox2D), 16);
            ...
            types[  26] = new TypeInfo(  26, "oid"        , "oid"      , PgDbType.Integer, typeof(int), typeof(PgInt32), sizeof(int));
            ...
            types[1033] = new TypeInfo(1033, "aclitem"    , "aclitem"  , PgDbType.VarChar, typeof(string), typeof(string));
            types[1034] = new TypeInfo(1034, "aclitem[]"  , "_aclitem" , PgDbType.Array  , types[1033], typeof(string), typeof(string[]));

            types[  24] = new TypeInfo(  24, "regproc"    , "regproc"  , PgDbType.VarChar, typeof(string), typeof(string[]));
            types[1790] = new TypeInfo(1790, "refcursor"  , "refcursor", PgDbType.VarChar, typeof(string), typeof(string[]));
            types[2205] = new TypeInfo(2205, "regclass"   , "regclass" , PgDbType.VarChar, typeof(string), typeof(string[]));
            ...
            types[2278] = new TypeInfo(2278, "void"   , "void"   , PgDbType.Void, typeof(void), typeof(void), 0);

            //
            // INTERNAL TYPES
            //
            types[194] = new TypeInfo(194, "pg_node_tree", "pg_node_tree", PgDbType.Text, typeof(string), typeof(string));
